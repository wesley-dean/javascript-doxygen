...
run_fixture 13 jsdoc-typedef-virtual 'virtual JSDoc typedef is translated to a page alias'
...
run_fixture 19 jsdoc-type 'canonical JSDoc type annotation passes through unchanged'
